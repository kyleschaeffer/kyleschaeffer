...
function life2_comment($comment, $args, $depth){
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
		<div id="comment-<?php comment_ID(); ?>" class="comment-body">
			...
			<div class="comment-meta commentmetadata"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php printf(__('%1$s @ %2$s'), get_comment_date('M j, Y'),  get_comment_time('g:i a')) ?></a><?php edit_comment_link(__('// edit'),'  ','') ?></div>
			<div class="reply">
