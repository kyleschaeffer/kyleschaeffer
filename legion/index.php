...
// Ported to HTML5 Canvas with EaselJS by David Rousset - https://blogs.msdn.com/davrous
// Checkout EaselJS: an open-source JavaScript gaming framework : https://easeljs.com  
//------------------------------------------------------------------------------->
<html>
<head>
<title>HTML5 Platformer Game</title>
<link rel="shortcut icon" href="./icons/favicon.ico"/>
<META name="msapplication-task" content="name=XNA 4.0 Platformer Sample;action-uri=https://create.msdn.com/en-US/education/catalog/sample/platformer;icon-uri=./icons/XNA.ico"/>
<META name="msapplication-task" content="name=Tutorial: Animating sprites in Canvas with EaselJS;action-uri=https://blogs.msdn.com/b/davrous/archive/2011/07/21/html5-gaming-animating-sprites-in-canvas-with-easeljs.aspx;icon-uri=./icons/blogicon.ico"/>
<META name="msapplication-task" content="name=Tutorial: Building the core objects & handling collisions with EaselJS;action-uri=https://blogs.msdn.com/b/davrous/archive/2011/07/29/html5-gaming-building-the-core-objects-amp-handling-collisions-with-easeljs.aspx;icon-uri=./icons/blogicon.ico"/>
<META name="msapplication-task" content="name=Build my pinned site;action-uri=https://buildmypinnedsite.com;icon-uri=./icons/mypinnedsites.ico"/>
...
<body onload="setIE9PinnedModeExperience();">
	<div class="canvasHolder">
		<canvas id="platformerCanvas" width="800" height="480" style="background-color:black">
			Your browser doesn't support canvas. Please download IE9+ on <a href="https://ie.microsoft.com/testdrive">IE Test Drive</a> 
		</canvas>
	</div>
